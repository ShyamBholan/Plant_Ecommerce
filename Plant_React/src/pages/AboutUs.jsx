    ...
    return (
        <>
            <div className="container d-flex justify-content-center allign-items-center w-75 my-2">
                <img src="images/ai-image-1.jpg" className='img-fluid' alt="ai image girl with plant" />
            ...
            <div className="container d-flex justify-content-center allign-items-center w-75 my-2">
                ...
                <img src="images/ai-image-2.jpg" className='img-fluid' alt="ai image guys studying plant" />
            </div>
        </>
    )
}
